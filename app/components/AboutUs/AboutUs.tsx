...
export default function AboutUs() {
  return (
    <section
      id="about"
      className={`relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 ${poppins.className}`}
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-[28px] leading-[36px] tracking-[-0.02em] font-[600] text-[#1E1E1F]">
              About entertab
            </h3>
            <div className="space-y-4 text-[#707072] tracking-normal">
              <p className="text-[16px] leading-[24px] font-[400] tracking-normal">
