...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-dark-teal via-dark-teal-light to-dark-teal text-white">
      {/* Main Footer */}
      <div className="mx-auto w-full max-w-[96rem] px-4 sm:px-6 lg:px-8 pt-10 md:pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          ...
          {/* Column 4 - Decorative + Social */}
          <div className="flex flex-col items-end justify-between">
            {/* Decorative Shape Placeholder */}
            <div className="w-[120px] h-[120px] img-placeholder rounded-xl opacity-30 text-xs !bg-gradient-to-br !from-primary/40 !to-primary-light/40 mb-6">
              Shape
            </div>

            {/* WhatsApp */}
            <a
              href="https://wa.me/12027700575"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full bg-green-500 flex items-center justify-center hover:bg-green-600 transition-colors shadow-lg mb-4"
              aria-label="WhatsApp"
            >
              <svg
                width="24"
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto w-full max-w-[96rem] px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            {/* Copyright */}
            <p className="text-white/50 text-xs">
              Copyright &copy; 2026 EnterTab LLC
            </p>

            {/* Payment Icons */}
            <div className="flex items-center gap-3">
              {["Mastercard", "VISA", "Mada", "STC", "Tabby"].map(
                (payment) => (
                  <div
                    key={payment}
                    className="w-12 h-7 rounded bg-white/10 flex items-center justify-center text-[8px] text-white/60 font-medium"
                  >
                    {payment}
                  </div>
                )
            ...
            {/* Follow us - mobile only (desktop is in column 4) */}
          </div>
        </div>
      </div>
    </footer>
