...
export default function MobileAppPage() {
  return (
    <>
      ...
      {/* Title */}
      <div className="w-full text-center mt-12 py-4 px-4 mb-6 sm:mb-8 md:mb-10">
      ...
      {/* Image Container */}
      <div className="w-[90%] lg:w-[75%] md:w-[90%]  aspect-[44/24] mb-16 relative  rounded-3xl overflow-hidden shadow-xl mx-auto">
        <Image 
