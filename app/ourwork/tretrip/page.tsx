...
const infoItems: InfoItem[] = [
    ...
    {
        header: "Industry:",
        bullets: ["Travel & Logistics services"],
    },
    {
        header: "Services:",
        bullets: [
...
export default function tretripWorkPage() {
    return (
        <>
            <Header />
            <main className={`py-20 md:py-32 bg-gray-50 flex flex-col items-center`}
                ...
                <section className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 mb-20">
                    <div className="relative w-full h-[280px] sm:h-[420px] lg:h-[900px] rounded-2xl overflow-hidden shadow-xl">
                        <Image
                            src="/ourwork/tretrip/TretripHero.jpg"
                            alt="Tretrip hero"
                            fill
                            priority
                ...
                <section className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6 md:space-y-8">
                    <div className="relative w-full h-[280px] sm:h-[420px] lg:h-[1963px] rounded-2xl overflow-hidden shadow-lg">
                        <Image
                            src="/ourwork/tretrip/tretripPor1.png"
                            alt="Tretrip portfolio image 1"
                            fill
                            className="object-cover"
                            sizes="(min-width: 1280px) 1280px, (min-width: 1024px) 90vw, 100vw"
                        />
                    ...
                    <div className="relative w-full h-[280px] sm:h-[420px] lg:h-[1457px] rounded-2xl overflow-hidden shadow-lg">
                        <Image
                            src="/ourwork/tretrip/tretripPor2.png"
                            alt="Tretrip portfolio image 2"
                            fill
                            className="object-cover"
                            sizes="(min-width: 1280px) 1280px, (min-width: 1024px) 90vw, 100vw"
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        <div className="relative w-full h-[280px] sm:h-[420px] lg:h-[560px] rounded-2xl overflow-hidden shadow-lg">
                            <Image
                                src="/ourwork/tretrip/tretripPor3.png"
                                alt="Tretrip portfolio image 3"
                                fill
                                className="object-cover"
                        ...
                        <div className="relative w-full h-[280px] sm:h-[420px] lg:h-[560px] rounded-2xl overflow-hidden shadow-lg">
                            <Image
                                src="/ourwork/tretrip/tretripPor4.png"
                                alt="Tretrip portfolio image 4"
                                fill
                                className="object-cover"
                                sizes="(min-width: 1280px) 620px, (min-width: 768px) 48vw, 100vw"
                            />
